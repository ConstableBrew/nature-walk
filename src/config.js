...
export const HORIZON = HEIGHT * 0.8; // Apparent position of the horizon on the screen
...
export const RUN_MAX_SPEED = -WIDTH * 1.5;
export const RUN_TIME_TO_MAX_SPEED = 3 * 60;
export const GRAVITY = 0*-98.7;